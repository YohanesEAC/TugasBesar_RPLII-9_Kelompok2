 ...
 * @author YEAC
 */
public class frm_transaksi_cicil extends javax.swing.JFrame {
    koneksi dbsetting;
    String driver,database,user,pass,tgl;
    Object tabel;
    /**
     * Creates new form frm_transaksi_cici
     */
public frm_transaksi_cicil() {
        initComponents();
        txt_uang_muka.setVisible(false);
        ...
        Dimension frameSize = new Dimension ( 850, 560 );
        ...
        tabel_transaksi_cicil.setModel(tableModel);
        settableload();
        kode_ambil_barang();
    }
...
private void settableload()
{
    ...
    try
    {
        ...
        String SQL ="SELECT * FROM tabel_detail_transaksi_cicil WHERE kode_pembeli_cicil = '"+txt_kode_pembeli.getText()+"'";
    ...
    public void tambah_transaksi_cicil() throws ClassNotFoundException, SQLException{
         try{            
           Class.forName(driver);
           Connection kon = DriverManager.getConnection(database,user,pass);
           Statement stt = kon.createStatement();
           
           String sql= "SELECT MAX(right(kode_pembeli_cicil,5)) AS kode_pembeli_cicil FROM tabel_transaksi_cicil";
           ResultSet res = stt.executeQuery(sql);
        ...
        while(res.next())
            {
                if(res.first() == false)
                {
        txt_kode_pembeli.setText("FKC-000001");
                ...
                else
        {
                   ...
                   txt_kode_pembeli.setText("FKC-" + no);
    ...
    cbx_kode_barang.setSelectedItem("");
    ...
    txt_harga_total.setText("0");
     ...
     public void tambah_detail_transaksi_cicil() throws ClassNotFoundException, SQLException{
        Class.forName(driver);
        Connection kon = DriverManager.getConnection(database,user,pass);      
        String SQL ="select id_detail_transaksi_cicil from tabel_detail_transaksi_cicil";
        try {
            Statement stt = kon.createStatement();
            ResultSet res = stt.executeQuery(SQL);
            if(res.last()){
    ...
    private void initComponents() {
        ...
        tabel_transaksi_cicil = new javax.swing.JTable();
        ...
        txt_sisa_pembayaran = new javax.swing.JTextField();
        jLabel15 = new javax.swing.JLabel();
        jButton5 = new javax.swing.JButton();
        id_detail = new javax.swing.JTextField();
        cbx_kode_barang = new javax.swing.JComboBox();
        ...
        jdate_tenggang = new com.toedter.calendar.JDateChooser();
        pembuat1 = new Form.pembuat();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Form Transaksi Cicil");
        ...
        getContentPane().add(txt_banyak_barang, new org.netbeans.lib.awtextra.AbsoluteConstraints(534, 40, 50, -1));
        ...
        getContentPane().add(txt_nama_barang, new org.netbeans.lib.awtextra.AbsoluteConstraints(534, 109, 101, -1));
        ...
        getContentPane().add(txt_harga_satuan, new org.netbeans.lib.awtextra.AbsoluteConstraints(536, 146, 103, -1));

        txt_harga_total.setEditable(false);
        txt_harga_total.setText("0");
        getContentPane().add(txt_harga_total, new org.netbeans.lib.awtextra.AbsoluteConstraints(536, 184, 103, -1));

        txt_uang_muka.setEditable(false);
        txt_uang_muka.setText("0");
        txt_uang_muka.setToolTipText("Isi Menggunakan Angka !");
        getContentPane().add(txt_uang_muka, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 400, 6, -1));

        txt_sisa.setEditable(false);
        txt_sisa.setText("0");
        getContentPane().add(txt_sisa, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 455, 6, -1));

        txt_kode_pembeli.setEditable(false);
        getContentPane().add(txt_kode_pembeli, new org.netbeans.lib.awtextra.AbsoluteConstraints(132, 11, 75, -1));

        txt_tanggal_pembeli.setEditable(false);
        getContentPane().add(txt_tanggal_pembeli, new org.netbeans.lib.awtextra.AbsoluteConstraints(132, 50, 166, -1));
        ...
        getContentPane().add(txt_nama_pembeli, new org.netbeans.lib.awtextra.AbsoluteConstraints(132, 83, 166, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(132, 117, -1, 54));

        tabel_transaksi_cicil.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane2.setViewportView(tabel_transaksi_cicil);

        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 276, 837, 118));
        ...
        jLabel5.setText("Tenggang Waktu");
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(431, 40, -1, 20));

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Nama Barang");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(431, 112, -1, -1));

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Harga Satuan");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(431, 149, -1, -1));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("Harga Total");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(431, 187, -1, -1));
        ...
        getContentPane().add(btn_simpan, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 245, -1, -1));
        ...
        getContentPane().add(btn_batal, new org.netbeans.lib.awtextra.AbsoluteConstraints(111, 245, -1, -1));
        ...
        getContentPane().add(btn_keluar, new org.netbeans.lib.awtextra.AbsoluteConstraints(198, 245, -1, -1));

        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Kode Barang");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(431, 17, -1, -1));
        ...
        getContentPane().add(btn_cetak, new org.netbeans.lib.awtextra.AbsoluteConstraints(722, 400, 105, -1));

        txt_total_biaya.setEditable(false);
        getContentPane().add(txt_total_biaya, new org.netbeans.lib.awtextra.AbsoluteConstraints(118, 426, 152, -1));

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setText("Total Biaya");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 429, -1, -1));

        txt_sisa_pembayaran.setEditable(false);
        getContentPane().add(txt_sisa_pembayaran, new org.netbeans.lib.awtextra.AbsoluteConstraints(118, 455, 152, -1));

        jLabel15.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(255, 255, 255));
        jLabel15.setText("Sisa Pembayaran");
        getContentPane().add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 458, -1, -1));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(213, 11, -1, -1));
        ...
        getContentPane().add(id_detail, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 426, -1, -1));

        cbx_kode_barang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "SILAHKAN PILIH" }));
        cbx_kode_barang.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                cbx_kode_barangItemStateChanged(evt);
            }
        });
        getContentPane().add(cbx_kode_barang, new org.netbeans.lib.awtextra.AbsoluteConstraints(534, 14, -1, -1));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Stock");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(431, 74, -1, -1));

        txt_stock.setEditable(false);
        txt_stock.setText("0");
        getContentPane().add(txt_stock, new org.netbeans.lib.awtextra.AbsoluteConstraints(534, 71, 101, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(645, 184, 63, -1));

        txt_ket.setEditable(false);
        txt_ket.setText("Belum Lunas");
        txt_ket.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_ketActionPerformed(evt);
            }
        });
        getContentPane().add(txt_ket, new org.netbeans.lib.awtextra.AbsoluteConstraints(118, 481, 152, -1));

        jLabel16.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(255, 255, 255));
        jLabel16.setText("Keterangan");
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 484, -1, -1));

        jLabel17.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(255, 255, 255));
        jLabel17.setText("Uang Muka");
        getContentPane().add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 403, -1, -1));

        txt_uang.setEditable(false);
        getContentPane().add(txt_uang, new org.netbeans.lib.awtextra.AbsoluteConstraints(118, 400, 152, -1));

        jdate_tenggang.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                jdate_tenggangPropertyChange(evt);
            }
        });
        getContentPane().add(jdate_tenggang, new org.netbeans.lib.awtextra.AbsoluteConstraints(132, 189, -1, -1));
        ...
        getContentPane().add(pembuat1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 900, 580));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
         try {
            // TODO add your handling code here:
            tambah_transaksi_cicil();
            tambah_detail_transaksi_cicil();
            membersihkan_tabel();
            txt_nama_pembeli.setEnabled(true);
            txt_alamat_pembeli.setEnabled(true);
            jdate_tenggang.setEnabled(true);
    ...
    public void simpan_transaksi(){
          String data[]=new String[5];
                       String SQL = "INSERT INTO tabel_transaksi_cicil(kode_pembeli_cicil,"+"tanggal_pembeli,"+"nama_pembeli,"+"alamat_pembeli,"+"keterangan)"+"VALUES"
    ...
    private void btn_simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_simpanActionPerformed
        ...
        int total = Integer.parseInt(txt_harga_satuan.getText()) * Integer.parseInt(txt_banyak_barang.getText());
            ...
            //seting untuk uang muka
            
            //validasi input dan input ke database
          String data[]=new String[13];
        if((txt_kode_pembeli.getText().isEmpty()) ||(txt_nama_pembeli.getText().isEmpty()) ||(txt_alamat_pembeli.getText().isEmpty()) ||(txt_banyak_barang.getText().equals("0")) ||(txt_uang_muka.getText().equals(""))){
            JOptionPane.showMessageDialog(null, "Data Tidak Boleh Kosong, Silahkan Dilengkapi!");
        }
        else{     
                     String SQL1 = "INSERT INTO tabel_detail_transaksi_cicil(id_detail_transaksi_cicil,"+"kode_pembeli_cicil,"+"tanggal_pembeli,"+"nama_pembeli,"+"alamat_pembeli,"+"tenggang_waktu,"+"kode_barang,"+"nama_barang,"+"banyak_barang,"+"harga_satuan,"+"harga_total,"+"uang_muka,"+"sisa)"+"VALUES"
                     +"('"+id_detail.getText()+"',"
                        +"'"+txt_kode_pembeli.getText()+"',"
                        +"'"+txt_tanggal_pembeli.getText()+"',"
                        +"'"+txt_nama_pembeli.getText()+"',"
                        +"'"+txt_alamat_pembeli.getText()+"',"
                        +"'"+tgl+"',"
                        +"'"+cbx_kode_barang.getSelectedItem()+"',"
                     ...
                     try {
                         ...
                         double uangmuka = Double.parseDouble(txt_total_biaya.getText()) * 0.5;
                         double sisabayar = Double.parseDouble(txt_total_biaya.getText()) - uangmuka;
                         txt_uang.setText(String.valueOf(uangmuka));
                         txt_sisa_pembayaran.setText(String.valueOf(sisabayar));
                         cek_harga();
                         simpan_transaksi();   
                         Class.forName(driver);
                     Connection kon = DriverManager.getConnection(database,user,pass);                      
                 ...
                 //update jumlah stock pada tabel barang
                 stt.executeUpdate("update tabel_barang set kode_barang='"+cbx_kode_barang.getSelectedItem()+"',"+
                 "jumlah='"+txt_stock.getText()+"'where kode_barang ='"+cbx_kode_barang.getSelectedItem()+"'");
                 //update uang muka
                 stt.executeUpdate("update tabel_detail_transaksi_cicil set kode_pembeli_cicil='"+txt_kode_pembeli.getText()+"',"+
                 "uang_muka='"+txt_uang.getText()+"'where kode_pembeli_cicil ='"+txt_kode_pembeli.getText()+"'");
                //update sisa pembayaran
                 stt.executeUpdate("update tabel_detail_transaksi_cicil set kode_pembeli_cicil='"+txt_kode_pembeli.getText()+"',"+
                 "sisa='"+txt_sisa_pembayaran.getText()+"'where kode_pembeli_cicil ='"+txt_kode_pembeli.getText()+"'");
                ...
                data[5]=tgl;
                data[6]=cbx_kode_barang.getSelectedItem().toString();
                ...
                data[11]=txt_uang_muka.getText();
                data[12]=txt_sisa.getText();
                tambah_detail_transaksi_cicil();
                ...
                jdate_tenggang.setEnabled(false);
              membersihkan_teks();
    ...
    private void jdate_tenggangPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jdate_tenggangPropertyChange
        // TODO add your handling code here:
           if(jdate_tenggang.getDate()!=null) {
           SimpleDateFormat d=new SimpleDateFormat("yyyy-MM-dd");
               tgl = d.format(jdate_tenggang.getDate());
       }
    }//GEN-LAST:event_jdate_tenggangPropertyChange
    ...
    public void kode_ambil_barang(){
        ...
        try {
         ...
         ResultSet res = stt.executeQuery(sql);
         while(res.next()){
             cbx_kode_barang.addItem(res.getString("kode_barang"));
         }
        } catch (Exception e) {
        }
    }
    private void cbx_kode_barangItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbx_kode_barangItemStateChanged
        // TODO add your handling code here:
        String sql = "SELECT * FROM tabel_barang WHERE kode_barang = '"+cbx_kode_barang.getSelectedItem().toString()+"'";
        try {
              Class.forName(driver);
              Connection kon = DriverManager.getConnection(database,user,pass);                      
              Statement stt = kon.createStatement();  
    ...
    }//GEN-LAST:event_cbx_kode_barangItemStateChanged
...
public void cek_sisa(){
   
    int sisa = Integer.parseInt(txt_harga_total.getText()) - Integer.parseInt(txt_uang_muka.getText());
...
public void runReportDefault(String sourcefilename, HashMap hash) {
    ...
    private void txt_nama_pembeliKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_nama_pembeliKeyTyped
        // TODO add your handling code here:
        if (txt_nama_pembeli.getText().length() == 18 ) {
        evt.consume();
    }
    ...
    private void txt_alamat_pembeliKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_alamat_pembeliKeyTyped
        // TODO add your handling code here:
        if (txt_alamat_pembeli.getText().length() == 70 ) {
        evt.consume();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_transaksi_cicil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_transaksi_cicil().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox cbx_kode_barang;
    ...
    private com.toedter.calendar.JDateChooser jdate_tenggang;
    private Form.pembuat pembuat1;
    private javax.swing.JTable tabel_transaksi_cicil;
    ...
    private javax.swing.JTextField txt_sisa_pembayaran;
